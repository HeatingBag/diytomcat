...
public class Constant {
    ...
    public static final String textFormat_404 =
            "<html><head><title>DIY Tomcat/1.0.1 - Error report</title><style>" +
                    ...
                    "<u> The requested resource is not available.</u></p><HR size='1' noshade='noshade'><h3>DiyTomcat 1.0.1</h3>" +
                    "</body></html>";
    ...
    //常量contextXmlFile用户访问conf文件下的context.xml，在context.xml中指定资源的位置：WEB-INF/web.xml
